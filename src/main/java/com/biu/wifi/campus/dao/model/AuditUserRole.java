 ...
 * @author 
 */
public class AuditUserRole implements Serializable {
    /**
     * 主键
     */
    private Integer id;
    ...
    /**
     * 身份认证类型所需参数（如学校ID、学院ID、年级ID、宿舍楼ID等等）
     */
    ...
    public boolean equals(Object that) {
        ...
        AuditUserRole other = (AuditUserRole) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getAuthParam() == null ? other.getAuthParam() == null : this.getAuthParam().equals(other.getAuthParam()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getAuthParam() == null) ? 0 : getAuthParam().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", authParam=").append(authParam);
